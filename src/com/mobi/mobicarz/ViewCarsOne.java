...
public class ViewCarsOne extends Activity implements OnClickListener {
	...
	private void InitializeUI() {
		...
		if (settings3.getString("preference_logged", "").toString()
			...
			st_make1 = settings3.getString("st_preference_one_make", "");
			// st_make1kk=settings3.getInt("preference_one_make", 0);
			st_model1 = settings3.getString("st_preference_one_model", "");
		...
		/*System.out.println("this is make " + st_make1);
		System.out.println("this is model " + st_model1);*/
		...
		if (st_mileage1.equalsIgnoreCase("0-5000 miles")) {
			st_mileage1 = "Mileage1";
		} else if (st_mileage1.equalsIgnoreCase("5000-10000 miles")) {
			st_mileage1 = "Mileage2";
		} else if (st_mileage1.equalsIgnoreCase("10000-25000 miles")) {
			st_mileage1 = "Mileage3";
		} else if (st_mileage1.equalsIgnoreCase("25000-50000 miles")) {
			st_mileage1 = "Mileage4";
		} else if (st_mileage1.equalsIgnoreCase("50000-75000 miles")) {
			st_mileage1 = "Mileage5";
		} else if (st_mileage1.equalsIgnoreCase("75000-100000 miles")) {
			st_mileage1 = "Mileage6";
		} else if (st_mileage1.equalsIgnoreCase("100000+ miles")) {
			st_mileage1 = "Mileage7";
		}
		// YEAR
		if (st_year1.equalsIgnoreCase("Current Year")) {
			st_year1 = "Year1a";
		} else if (st_year1.equalsIgnoreCase("One Year Old")) {
			st_year1 = "Year1b";
		} else if (st_year1.equalsIgnoreCase("Upto 3 Years Old")) {
			st_year1 = "Year1";
		} else if (st_year1.equalsIgnoreCase("Upto 5 Years Old")) {
			st_year1 = "Year2";
		} else if (st_year1.equalsIgnoreCase("Upto 10 Years Old")) {
			st_year1 = "Year3";
		} else if (st_year1.equalsIgnoreCase("Any")) {
			st_year1 = "Year4";
		}

		if (st_price1.equalsIgnoreCase("Below 20,000")) {
			st_price1 = "Price1";
		} else if (st_price1.equalsIgnoreCase("20,000 to 50,000")) {
			st_price1 = "Price2";
		} else if (st_price1.equalsIgnoreCase("50,000 to 75,000")) {
			st_price1 = "Price3";
		} else if (st_price1.equalsIgnoreCase("75,000 to 100,000")) {
			st_price1 = "Price4";
		} else if (st_price1.equalsIgnoreCase("Above 100,000")) {
			st_price1 = "Price5";
		}
	...
	//	System.out.println("this is preference one url" + url1);
		...
		try {
			...
			contacts = json.getJSONArray("GetCarsFilterAndroidMobileResult");
