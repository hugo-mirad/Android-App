...
public class PreferencesFive extends Activity implements OnClickListener {
	...
	String PreferencesmodelnameSelected_five = null,
			PreferencesmakenameSelected_five = null,
			PreferencesMillageSelected_five = null,
			PreferencesYearSelected_five = null,
			PreferencespriceSelected_five = null, Preferencesmodel_five = null;
	...
	String preferenceone_model="", preferencethree_model = "",
			preferencefour_model = "", preferencetwo_model = "";
	String model_five;
	@Override
	...
	private void InitializeUI() {
		...
		SharedPreferences p_settings5 = getSharedPreferences(PREFS_NAME, 0);
		if (p_settings5.getString("preference_logged5", "").toString()
				.equals("logged_5")) {

			// st_make1=settings3.getString("preference_one_make", "");
			st_make1kk = p_settings5.getInt("preference_five_make", 0);
			// st_model1=settings3.getString("preference_one_model","");
			st_model1kk = p_settings5.getInt("preference_five_model", 0);
			st_mileage5 = p_settings5.getString("preference_five_mileage", "");
			st_price5 = p_settings5.getString("preference_five_price", "");
			st_year5 = p_settings5.getString("preference_five_year", "");
			st_zip5 = p_settings5.getString("preference_five_zip", "");
		//	System.out.println("this is prference five price" + st_price5);
		}
		...
		spinnerMillage.setAdapter(new ArrayAdapter<String>(
				PreferencesFive.this, android.R.layout.simple_spinner_item,
				millage));
		...
		int prv_state = programmingList3.indexOf(st_mileage5);
		...
		spinnerMillage.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				PreferencesMillageSelected_five = (String) spinnerMillage
						.getItemAtPosition(spinnerMillage
								.getSelectedItemPosition());
			}
		...
		int prv_state1 = programmingList4.indexOf(st_year5);
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Preferenceslist.PreferencesYearSelected = (String) spinnerYear
						.getItemAtPosition(spinnerYear
								.getSelectedItemPosition());
				PreferencesYearSelected_five = (String) spinnerYear
						.getItemAtPosition(spinnerYear
								.getSelectedItemPosition());
			}
		...
		int prv_state2 = programmingList5.indexOf(st_price5);
		...
		spinnerPrice.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Preferenceslist.PreferencespriceSelected = spinnerPrice
						...
						.toString();
				PreferencespriceSelected_five = spinnerPrice.getItemAtPosition(
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String url1 = "http://www.unitedcarexchange.com/MobileService/ServiceMobile.svc/GetCarsFilterAndroidMobile/"
						+ PreferencesmakenameSelected_five.replace(" ", "%20")
						+ "/"
						+ PreferencesmodelnameSelected_five.replace(" ", "%20")
						+ "/"
						+ MillageAl
						+ "/"
						+ yearAl
				...
				try {
					...
					if(n1.equals("0")){
					 model_five = PreferencesmakenameSelected_five
							+ " , " + Preferencesmodel_five + " , "
							+ PreferencesYearSelected_five + " , " + ("$ ")
							+ PreferencespriceSelected_five + " , "
							+ PreferencesMillageSelected_five+".";
					}else{
						 model_five = PreferencesmakenameSelected_five
								+ " , " + Preferencesmodel_five + " , "
								+ PreferencesYearSelected_five + " , " + ("$ ")
								+ PreferencespriceSelected_five + " , "
								+ PreferencesMillageSelected_five+" , "+n1+".";
					}
					...
					editor.putString("preference_logged5", "logged_5");
					editor.putString("st_preference_five_make",
							PreferencesmakenameSelected_five);
					editor.putInt("preference_five_make", kk);
					editor.putString("st_preference_five_model",
							PreferencesmodelnameSelected_five);
					editor.putInt("preference_five_model", model_kk);
					editor.putString("preference_five_year",
							PreferencesYearSelected_five);
					editor.putString("preference_five_price",
							PreferencespriceSelected_five);
					editor.putString("preference_five_mileage",
							PreferencesMillageSelected_five);
					editor.putString("preference_five_zip", n1);
					editor.putString("model_five", model_five);
					editor.putString("preference_five_result",
							service_pagecount);
					...
					SharedPreferences settings7 = getSharedPreferences(
							PREFS_NAME, 0);
					if (settings7.getString("preference_logged4", "")
							.toString().equals("logged_4")) {

						preferencefour_model = settings7.getString(
								"model_four", "");
					}
					if (preferenceone_model.equals(model_five)
							|| preferencetwo_model.equals(model_five)
							|| preferencethree_model.equals(model_five)
							|| preferencefour_model.equals(model_five)) {
						Toast.makeText(getApplicationContext(),
	...
	public class MyOnItemSelectedListener implements OnItemSelectedListener {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int pos,
			...
			PreferencesmakenameSelected_five = (String) spinnerMakes
			...
			spinnerModels
					.setOnItemSelectedListener(new OnItemSelectedListener() {
						...
						public void onItemSelected(AdapterView<?> arg0,
							...
							// TODO Auto-generated method stub
							PreferencesmodelnameSelected_five = (String) spinnerModels
									.getItemAtPosition(spinnerModels
											.getSelectedItemPosition());
							Preferencesmodel_five = (String) spinnerModels
									.getItemAtPosition(spinnerModels
											.getSelectedItemPosition());
							model_kk = spinnerModels.getSelectedItemPosition();
							if (PreferencesmodelnameSelected_five
									.equals("ALL MODELS")) {
								PreferencesmodelnameSelected_five = "ALL";
							}
