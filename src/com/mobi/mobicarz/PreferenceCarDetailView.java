...
public class PreferenceCarDetailView extends Activity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.call:
			...
			TelephonyManager num = (TelephonyManager) PreferenceCarDetailView.this
					.getSystemService(Context.TELEPHONY_SERVICE);
		...
		//	System.out.println("this is clicking features button");
			...
			if (contacts1.length() == 0) {
				...
				Intent features_in = new Intent(getApplicationContext(),
						PreferenceCarDetailFeature.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.cardetails_back:
			...
			Intent in1 = new Intent(getApplicationContext(), ViewCarsOne.class)
					.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(in1);
			// finish();
			break;
