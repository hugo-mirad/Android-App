...
public class PreferencesTwo extends Activity implements OnClickListener {
	...
	String PreferencesmodelnameSelected_two = null,
			PreferencesmakenameSelected_two = null,
			PreferencesMillageSelected_two = null,
			PreferencesYearSelected_two = null,
			PreferencespriceSelected_two = null, Preferencesmodel_two = null;
	...
	String st_make1 = "", st_model1, st_price1, st_mileage1, st_year1,
			st_zip1 = "";
	...
	private void InitializeUI() {
		...
		if (settings4.getString("preference_logged2", "").toString()
			...
			st_make1kk = settings4.getInt("preference_two_make", 0);
			// st_model1=settings3.getString("preference_one_model","");
			st_model1kk = settings4.getInt("preference_two_model", 0);
			st_mileage1 = settings4.getString("preference_two_mileage", "");
			st_price1 = settings4.getString("preference_two_price", "");
			st_year1 = settings4.getString("preference_two_year", "");
			st_zip1 = settings4.getString("preference_two_zip", "");
		}
		...
		spinnerMillage.setAdapter(new ArrayAdapter<String>(
				PreferencesTwo.this, android.R.layout.simple_spinner_item,
				millage));

		List<String> programmingList3 = Arrays.asList(millage);
		boolean result = programmingList3.contains(millage);

		int prv_state = programmingList3.indexOf(st_mileage1);
		...
		spinnerMillage.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				PreferencesMillageSelected_two = (String) spinnerMillage
						.getItemAtPosition(spinnerMillage
								.getSelectedItemPosition());
			}
		...
		int prv_state1 = programmingList4.indexOf(st_year1);
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Preferenceslist.PreferencesYearSelected = (String) spinnerYear
						.getItemAtPosition(spinnerYear
								.getSelectedItemPosition());
				PreferencesYearSelected_two = (String) spinnerYear
						.getItemAtPosition(spinnerYear
								.getSelectedItemPosition());
			}
		...
		int prv_state2 = programmingList5.indexOf(st_price1);
		...
		spinnerPrice.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Preferenceslist.PreferencespriceSelected = spinnerPrice
						...
						.toString();
				PreferencespriceSelected_two = spinnerPrice.getItemAtPosition(
		...
		if (st_zip1.equals("0")) {
			...
			et_zip.setText(st_zip1);
		}
		// et_zip.setText(st_zip2);
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String url1 = "http://www.unitedcarexchange.com/MobileService/ServiceMobile.svc/GetCarsFilterAndroidMobile/"
						+ PreferencesmakenameSelected_two.replace(" ", "%20")
						+ "/"
						+ PreferencesmodelnameSelected_two.replace(" ", "%20")
						+ "/"
						+ MillageAl
						+ "/"
						+ yearAl
			...
			//	System.out.println("this is json obj" + json);
				try {
					...
					if(n1.equals("0")){
					model_two = PreferencesmakenameSelected_two + " , "
							+ Preferencesmodel_two + " , "
							+ PreferencesYearSelected_two + " , " + ("$ ")
							+ PreferencespriceSelected_two + " , "
							+ PreferencesMillageSelected_two+".";
					}else{
						model_two = PreferencesmakenameSelected_two + " , "
								+ Preferencesmodel_two + " , "
								+ PreferencesYearSelected_two + " , " + ("$ ")
								+ PreferencespriceSelected_two + " , "
								+ PreferencesMillageSelected_two+" , "+n1+".";
					}
					/*System.out.println("this is preference data in page"
							+ model_two);*/
					// final String PREFS_NAME = "LoginPrefs";
					SharedPreferences settings_pf2 = getSharedPreferences(
							PREFS_NAME, 0);
					SharedPreferences.Editor editor = settings_pf2.edit();
					editor.putString("preference_logged2", "logged_2");
					editor.putString("st_preference_two_make",
							PreferencesmakenameSelected_two);
					editor.putInt("preference_two_make", kk);
					editor.putString("st_preference_two_model",
							PreferencesmodelnameSelected_two);
					editor.putInt("preference_two_model", model_kk);
					editor.putString("preference_two_year",
							PreferencesYearSelected_two);
					editor.putString("preference_two_price",
							PreferencespriceSelected_two);
					editor.putString("preference_two_mileage",
							PreferencesMillageSelected_two);
					editor.putString("preference_two_zip", n1);
					editor.putString("model_two", model_two);
					editor.putString("preferencetwo_result", service_pagecount);
					...
					SharedPreferences settings5 = getSharedPreferences(
							PREFS_NAME, 0);
					if (settings5.getString("preference_logged3", "")
							.toString().equals("logged_3")) {

						preferencethree_model = settings5.getString(
								"model_three", "");
					...
					if (preferenceone_model.equals(model_two)
							|| preferencethree_model.equals(model_two)
							|| preferencefour_model.equals(model_two)
							|| preferencefive_model.equals(model_two)) {
						Toast.makeText(getApplicationContext(),
	...
	public class MyOnItemSelectedListener implements OnItemSelectedListener {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int pos,
			...
			PreferencesmakenameSelected_two = (String) spinnerMakes
			...
			spinnerModels
					.setOnItemSelectedListener(new OnItemSelectedListener() {
						...
						public void onItemSelected(AdapterView<?> arg0,
							...
							// TODO Auto-generated method stub
							PreferencesmodelnameSelected_two = (String) spinnerModels
									.getItemAtPosition(spinnerModels
											.getSelectedItemPosition());
							Preferencesmodel_two = (String) spinnerModels
									.getItemAtPosition(spinnerModels
											.getSelectedItemPosition());
							model_kk = spinnerModels.getSelectedItemPosition();
							if (PreferencesmodelnameSelected_two
									.equals("ALL MODELS")) {
								PreferencesmodelnameSelected_two = "ALL";
							}
