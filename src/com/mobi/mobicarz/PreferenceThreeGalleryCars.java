...
public class PreferenceThreeGalleryCars extends Activity{
	...
	//	System.out.println("this is gallery view");
		...
		String year=PreferenceCarDetailViewThree.year1;
		String make=PreferenceCarDetailViewThree.make1;
		String model=PreferenceCarDetailViewThree.model1;
	...
	//	System.out.println("this is no of cars" + i);
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finish();
				/*Intent in =new Intent(getApplicationContext(),PreferenceCarDetailViewThree.class);
				startActivity(in);*/
			}
		});
