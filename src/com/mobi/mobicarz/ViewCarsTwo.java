...
public class ViewCarsTwo extends Activity implements OnClickListener {
	...
	String st_make2 = "", st_model2, st_price2, st_mileage2, st_year2,
			st_zip2 = "", url1, n1 = "";
	...
	private void InitializeUI() {
		...
		SharedPreferences vi_settings4 = getSharedPreferences(PREFS_NAME, 0);
		if (vi_settings4.getString("preference_logged2", "").toString()
				.equals("logged_2")) {

			st_make2 = vi_settings4.getString("st_preference_two_make", "");
			// st_make1kk=settings3.getInt("preference_one_make", 0);
			st_model2 = vi_settings4.getString("st_preference_two_model", "");
			// st_model1kk=settings3.getInt("preference_one_model", 0);
			st_mileage2 = vi_settings4.getString("preference_two_mileage", "");
			st_price2 = vi_settings4.getString("preference_two_price", "");
			st_year2 = vi_settings4.getString("preference_two_year", "");
			st_zip2 = vi_settings4.getString("preference_two_zip", "");
		}
		/*System.out.println("this is make " + st_make2);
		System.out.println("this is model " + st_model2);*/
		...
		if (st_mileage2.equalsIgnoreCase("0-5000 miles")) {
			st_mileage2 = "Mileage1";
		} else if (st_mileage2.equalsIgnoreCase("5000-10000 miles")) {
			st_mileage2 = "Mileage2";
		} else if (st_mileage2.equalsIgnoreCase("10000-25000 miles")) {
			st_mileage2 = "Mileage3";
		} else if (st_mileage2.equalsIgnoreCase("25000-50000 miles")) {
			st_mileage2 = "Mileage4";
		} else if (st_mileage2.equalsIgnoreCase("50000-75000 miles")) {
			st_mileage2 = "Mileage5";
		} else if (st_mileage2.equalsIgnoreCase("75000-100000 miles")) {
			st_mileage2 = "Mileage6";
		} else if (st_mileage2.equalsIgnoreCase("100000+ miles")) {
			st_mileage2 = "Mileage7";
		}
		// YEAR
		if (st_year2.equalsIgnoreCase("Current Year")) {
			st_year2 = "Year1a";
		} else if (st_year2.equalsIgnoreCase("One Year Old")) {
			st_year2 = "Year1b";
		} else if (st_year2.equalsIgnoreCase("Upto 3 Years Old")) {
			st_year2 = "Year1";
		} else if (st_year2.equalsIgnoreCase("Upto 5 Years Old")) {
			st_year2 = "Year2";
		} else if (st_year2.equalsIgnoreCase("Upto 10 Years Old")) {
			st_year2 = "Year3";
		} else if (st_year2.equalsIgnoreCase("Any")) {
			st_year2 = "Year4";
		}

		if (st_price2.equalsIgnoreCase("Below 20,000")) {
			st_price2 = "Price1";
		} else if (st_price2.equalsIgnoreCase("20,000 to 50,000")) {
			st_price2 = "Price2";
		} else if (st_price2.equalsIgnoreCase("50,000 to 75,000")) {
			st_price2 = "Price3";
		} else if (st_price2.equalsIgnoreCase("75,000 to 100,000")) {
			st_price2 = "Price4";
		} else if (st_price2.equalsIgnoreCase("Above 100,000")) {
			st_price2 = "Price5";
		}
		...
		searchresult_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int arg2,
				...
				Intent previewMessage = new Intent(getApplicationContext(),
						PreferenceCarDetailViewTwo.class)
	...
	private void getPreferenceTwoData() {
		// TODO Auto-generated method stub
