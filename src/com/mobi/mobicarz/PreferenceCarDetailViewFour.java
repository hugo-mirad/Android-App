...
public class PreferenceCarDetailViewFour extends Activity implements
		OnClickListener {
				...
				public void onCheckedChanged(CompoundButton arg0,
					...
					if (mylist.isChecked()) {
						...
						com.mobi.adapters.MySQLiteHelper helper = new com.mobi.adapters.MySQLiteHelper(
								PreferenceCarDetailViewFour.this);
						db = helper.open();
	...
	public void onClick(View v) {
		...
		case R.id.call:
			...
			TelephonyManager num = (TelephonyManager) PreferenceCarDetailViewFour.this
					.getSystemService(Context.TELEPHONY_SERVICE);
		...
		//System.out.println("this is clicking features button");
			...
			if (contacts1.length() == 0) {
				...
				Intent features_in = new Intent(getApplicationContext(),
						PreferenceCarDetailViewFourFeaturs.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.viewgallery:
			...
			//	System.out.println("this is no of cars" + i);
				...
				Intent previewMessage = new Intent(getApplicationContext(),
						PreferenceFourGalleryCars.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.cardetails_back:
			...
			Intent in1 = new Intent(getApplicationContext(), ViewCarsFour.class)
					.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(in1);
			break;
		default:
