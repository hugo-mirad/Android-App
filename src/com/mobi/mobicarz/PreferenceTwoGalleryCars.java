...
public class PreferenceTwoGalleryCars extends Activity {
	...
	Button back;
	private com.mobi.adapters.ViewGalleryAdapter galImageAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//	System.out.println("this is gallery view");
			...
			String year = PreferenceCarDetailViewTwo.year1;
			String make = PreferenceCarDetailViewTwo.make1;
			String model = PreferenceCarDetailViewTwo.model1;
			...
			gallery.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> parent, View view,
					...
					// Toast.makeText(GalleryCars.this,
					// "Your selected position = " + pos,
					// Toast.LENGTH_SHORT).show();
					int k = pos + 1;
					// tv_gallerycarno.setText("Your selected car = " + k);
			...
			galImageAdapter = new com.mobi.adapters.ViewGalleryAdapter(this,
					mystringArray);
