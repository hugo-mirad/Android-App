...
public class PreferenceCarDetailViewFive extends Activity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.call:
			...
			TelephonyManager num = (TelephonyManager) PreferenceCarDetailViewFive.this
					.getSystemService(Context.TELEPHONY_SERVICE);
		...
		case R.id.cardetails_features:
			...
			if (contacts1.length() == 0) {
				...
				Intent features_in = new Intent(getApplicationContext(),
						PreferenceCarDetailViewFiveFeatures.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.viewgallery:
			if (carGallerList.size() > 0) {
				...
				Intent previewMessage = new Intent(getApplicationContext(),
						PreferenceFiveGalleryCars.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.cardetails_back:
			...
			Intent in1 = new Intent(getApplicationContext(), ViewCarsFive.class)
					.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(in1);
			break;
		default:
