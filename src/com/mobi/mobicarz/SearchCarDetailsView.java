...
public class SearchCarDetailsView extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//	System.out.println("this is car detail view");
			...
			zip = getIntent().getIntExtra("zip", 0);
			//System.out.println("this is zip value" + zip);
	...
	public void onClick(View v) {
		...
		case R.id.call:
			...
			TelephonyManager num = (TelephonyManager) SearchCarDetailsView.this
					.getSystemService(Context.TELEPHONY_SERVICE);
		...
		case R.id.cardetails_features:
			...
			if (contacts1.length() == 0) {
				...
				Intent features_in = new Intent(getApplicationContext(),
						SearchCarDetails_Features.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
