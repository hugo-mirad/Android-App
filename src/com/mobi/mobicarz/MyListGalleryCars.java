...
public class MyListGalleryCars extends Activity{
	...
	//	System.out.println("this is no of cars" + i);
		...
		String year=MyListCarDetailsView.year1;
		String make=MyListCarDetailsView.make1;
		String model=MyListCarDetailsView.model1;
