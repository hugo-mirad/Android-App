...
public class PreferenceCarDetailViewThree extends Activity implements
		OnClickListener {
			...
			mylist.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton arg0,
					...
					if (mylist.isChecked()) {
						...
						Toast.makeText(PreferenceCarDetailViewThree.this,
	...
	public void onClick(View v) {
		...
		case R.id.call:
			...
			TelephonyManager num = (TelephonyManager) PreferenceCarDetailViewThree.this
					.getSystemService(Context.TELEPHONY_SERVICE);
		...
		case R.id.cardetails_features:
			...
			if (contacts1.length() == 0) {
				...
				Intent features_in = new Intent(getApplicationContext(),
						PreferenceCarDetailViewThreeFeaturs.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		case R.id.viewgallery:
			...
			//	System.out.println("this is no of cars" + i);
				...
				Intent previewMessage = new Intent(getApplicationContext(),
						PreferenceThreeGalleryCars.class)
						.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
