...
public class PreferenceCarDetailFeature extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//	System.out.println("this is features view");
			...
			features_carid = PreferenceCarDetailView.car_id;
			System.out.println("this is featur id "+features_carid);
