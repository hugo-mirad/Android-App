...
public class ViewCarsThree extends Activity implements OnClickListener {
	...
	private void InitializeUI() {
		...
		if (vi_settings4.getString("preference_logged3", "").toString()
				.equals("logged_3")) {

			st_make3 = vi_settings4.getString("st_preference_three_make", "");
			// st_make1kk=settings3.getInt("preference_one_make", 0);
			st_model3 = vi_settings4.getString("st_preference_three_model", "");
			// st_model1kk=settings3.getInt("preference_one_model", 0);
			st_mileage3 = vi_settings4
					.getString("preference_three_mileage", "");
			st_price3 = vi_settings4.getString("preference_three_price", "");
			st_year3 = vi_settings4.getString("preference_three_year", "");
			st_zip3 = vi_settings4.getString("preference_three_zip", "");
		}
		/*System.out.println("this is make " + st_make3);
		System.out.println("this is model " + st_model3);*/
		...
		if (st_mileage3.equalsIgnoreCase("0-5000 miles")) {
			st_mileage3 = "Mileage1";
		} else if (st_mileage3.equalsIgnoreCase("5000-10000 miles")) {
			st_mileage3 = "Mileage2";
		} else if (st_mileage3.equalsIgnoreCase("10000-25000 miles")) {
			st_mileage3 = "Mileage3";
		} else if (st_mileage3.equalsIgnoreCase("25000-50000 miles")) {
			st_mileage3 = "Mileage4";
		} else if (st_mileage3.equalsIgnoreCase("50000-75000 miles")) {
			st_mileage3 = "Mileage5";
		} else if (st_mileage3.equalsIgnoreCase("75000-100000 miles")) {
			st_mileage3 = "Mileage6";
		} else if (st_mileage3.equalsIgnoreCase("100000+ miles")) {
			st_mileage3 = "Mileage7";
		}
		// YEAR
		if (st_year3.equalsIgnoreCase("Current Year")) {
			st_year3 = "Year1a";
		} else if (st_year3.equalsIgnoreCase("One Year Old")) {
			st_year3 = "Year1b";
		} else if (st_year3.equalsIgnoreCase("Upto 3 Years Old")) {
			st_year3 = "Year1";
		} else if (st_year3.equalsIgnoreCase("Upto 5 Years Old")) {
			st_year3 = "Year2";
		} else if (st_year3.equalsIgnoreCase("Upto 10 Years Old")) {
			st_year3 = "Year3";
		} else if (st_year3.equalsIgnoreCase("Any")) {
			st_year3 = "Year4";
		}

		if (st_price3.equalsIgnoreCase("Below 20,000")) {
			st_price3 = "Price1";
		} else if (st_price3.equalsIgnoreCase("20,000 to 50,000")) {
			st_price3 = "Price2";
		} else if (st_price3.equalsIgnoreCase("50,000 to 75,000")) {
			st_price3 = "Price3";
		} else if (st_price3.equalsIgnoreCase("75,000 to 100,000")) {
			st_price3 = "Price4";
		} else if (st_price3.equalsIgnoreCase("Above 100,000")) {
			st_price3 = "Price5";
		}
		...
		searchresult_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int arg2,
				...
				Intent previewMessage = new Intent(getApplicationContext(),
						PreferenceCarDetailViewThree.class)
	...
	private void getPreferenceThreeData() {
		// TODO Auto-generated method stub
