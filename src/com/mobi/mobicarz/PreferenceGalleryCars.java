...
public class PreferenceGalleryCars extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String year=PreferenceCarDetailView.year1;
		String make=PreferenceCarDetailView.make1;
		String model=PreferenceCarDetailView.model1;
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finish();
				/*Intent in=new Intent(getApplicationContext(),PreferenceCarDetailView.class);
				startActivity(in);*/
			}
		});
